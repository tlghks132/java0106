...
public class BasicAlgorithm {
	...
	public static void main(String[] args) {
		...
		// 합계를 구할때 합을 저장할 변수를 규칙이 성립되기 전 또는 합을 구하기 전까지의 값으로 초기화.		
		...
		//피보나치 수열은 첫번째와 두번째는 무조건 1 세번째부터는 이전 2개 항의 합.
		...
		if (su == 1) {
			...
			//두 번째 항 까지는 규칙이 적용되지 않기 때문에 미리 합계를 구해놓아야 함.
			sum  = 2;
			//현재 항의 두번재 이전 데이터를 저장할 변수
			int f2 = 1;
